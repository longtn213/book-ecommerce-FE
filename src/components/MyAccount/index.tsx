...
import {changePasswordApi, getCurrentUser, updateUserProfile} from "@/services/userService";
    ...
    useEffect(() => {
        async function fetchUser() {
            try {
                ...
                if (res?.data?.data) {
                    const u = res.data.data;  // <-- sửa đúng
                    ...
                    setFormData({
                        ...
                        birthDate: u.birthDate?.substring(0, 10) || "",
                    ...
                    <div className="flex flex-col xl:flex-row gap-7.5">
                            ...
                            <div className="flex xl:flex-col">
                                <div className="hidden lg:flex flex-wrap items-center gap-5 py-6 px-4 sm:px-7.5 xl:px-9 border-r xl:border-r-0 xl:border-b border-gray-3">
                                    <div className="max-w-[64px] w-full h-16 rounded-full overflow-hidden">
                                        <Image
                                            key={user?.avatarUrl}
                                            src={user?.avatarUrl || "/images/users/default-avatar.png"}
                                            alt="user"
                                            width={64}
                                            height={64}
                                        />
                                ...
                                <div className="p-4 sm:p-7.5 xl:p-9">
                                    <div className="flex flex-wrap xl:flex-nowrap xl:flex-col gap-4">
                                        ...
                                        {/* TAB BUTTON: ACCOUNT DETAILS */}
                                        <button
                                            onClick={() => setActiveTab("account-details")}
                                            className={`flex items-center rounded-md gap-2.5 py-3 px-4.5 
                        ease-out duration-200 hover:bg-blue hover:text-white ${
                        ...
                        ease-out duration-200 hover:bg-blue hover:text-white ${
                                        ...
                                        <button
                                            ...
                                            className="flex items-center rounded-md gap-2.5 py-3 px-4.5
                      text-dark-2 bg-gray-1 hover:bg-blue hover:text-white ease-out duration-200"
                                        >
                                            Logout
                                        </button>
