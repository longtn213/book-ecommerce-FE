...
const BestSellerSingleItem = ({ item }: { item: any }) => {
    ...
    return (
        <div className="group bg-white rounded-xl p-4 shadow hover:shadow-lg transition-all duration-300 border border-gray-100">

            {/* IMAGE WRAPPER */}
            <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] h-[260px] flex items-center justify-center">
                <Image
          ...
          "
                >
                    ...
                    <button
                        ...
                        className="w-9 h-9 rounded-lg bg-white shadow hover:bg-blue-500 hover:text-white flex items-center justify-center transition"
                    >
                        <svg
                    ...
                    <button
                        ...
                        className={`
              w-9 h-9 rounded-lg shadow flex items-center justify-center transition
            ...
            <div className="pt-5 text-center">
                ...
                {/* Title */}
                <h3 className="font-medium text-dark text-base hover:text-blue-500 transition line-clamp-2 mb-1.5">
