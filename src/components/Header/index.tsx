    ...
    "
                ...
                <span className="block relative cursor-pointer w-5.5 h-5.5">
                  <span className="du-block absolute right-0 w-full h-full">
                    <span
                        className={`block relative top-0 left-0 bg-blue-600 rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-[0] ${
                            !navigationOpen && "!w-full delay-300"
                        }`}
                    ></span>
                    <span
                        className={`block relative top-0 left-0 bg-blue-600 rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-150 ${
                            !navigationOpen && "!w-full delay-400"
                        }`}
                    ></span>
                    <span
                        className={`block relative top-0 left-0 bg-blue-600 rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-200 ${
                  ...
                  <span className="block absolute right-0 w-full h-full rotate-45">
                    <span
                        className={`block bg-blue-600 rounded-sm ease-in-out duration-200 delay-300 absolute left-2.5 top-0 w-0.5 h-full ${
                            !navigationOpen && "!h-0 delay-[0] "
                        }`}
                    ></span>
                    <span
                        className={`block bg-blue-600 rounded-sm ease-in-out duration-200 delay-400 absolute left-0 top-2.5 w-full h-0.5 ${
